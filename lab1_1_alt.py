...
def find_minimum_dichotomy(f, eps, a, b):
    return find_minimum(dichotomy_borders, dichotomy_borders, f, eps, a, b)
...
def find_minimum_golden(f, eps, a, b):
    return find_minimum(golden_borders_first, golden_borders, f, eps, a, b)
...
def find_minimum_fibonacci(f, eps, a, b):
    ...
    return find_minimum(fibonacci_borders_first, fibonacci_borders, f, eps, a, b)
